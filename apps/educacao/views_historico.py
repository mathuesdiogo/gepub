        ...
        rows_calc.append(
            {
                ...
                "serie_ano": m.turma.get_serie_ano_display() if hasattr(m.turma, "get_serie_ano_display") else m.turma.serie_ano,
                "matriz": getattr(getattr(m.turma, "matriz_curricular", None), "nome", "—"),
                "atividade_extra": getattr(getattr(m.turma, "curso", None), "nome", "—"),
