...
def enable_comunicacao_module(apps, schema_editor):
    ...
    municipio_ids = MunicipioModuloAtivo.objects.values_list("municipio_id", flat=True).distinct()
    ...
    secretaria_ids = SecretariaModuloAtivo.objects.values_list("secretaria_id", flat=True).distinct()
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(enable_comunicacao_module, noop_reverse),
    ]
